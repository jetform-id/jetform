defmodule AppWeb.CoreComponents do
  ...
  def modal(assigns) do
    ...
    >
      <div
        id={"#{@id}-bg"}
        class="bg-slate-200/90 fixed inset-0 transition-opacity"
        aria-hidden="true"
      />
      <div
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class={["w-full p-4 sm:p-6 lg:py-8", @width]}>
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-md bg-white p-12 shadow-lg ring-1 transition"
            >
  ...
  attr :rest_class, :string, default: nil
    ...
    <div phx-feedback-for={@name} class={[@wrapper_class]}>
      <label class="flex items-center gap-4 text-sm leading-6 text-zinc-600">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class={["rounded border-zinc-300 text-zinc-900 focus:ring-0", @rest_class]}
          {@rest}
        />
        <%= @label %>
      </label>
